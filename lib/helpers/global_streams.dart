...
class GlobalStreams {
  ...
  ValueStream<bool> get eventSkillListFilters => _streamSkillListFilters.stream;
  ...
  Function(bool) get triggerSkillListFilters =>
      _streamSkillListFilters.sink.add;
